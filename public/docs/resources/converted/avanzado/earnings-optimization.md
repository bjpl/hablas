...
**Cultural Context:** US gig economy earnings
...
|---------|---------|---------------|---------|
| Tip / Gratuity | Propina | *proh-PEE-nah* | Additional payment for good service |
| Cash tip | Propina en efectivo | *proh-PEE-nah en eh-fek-TEE-voh* | Physical money tip |
| In-app tip | Propina en la aplicación | *proh-PEE-nah en lah ah-plee-kah-see-ON* | Digital tip through platform |
| Value-added service | Servicio de valor agregado | *ser-VEE-see-oh deh vah-LOR ah-greh-GAH-doh* | Extra services beyond basic |
| Referral | Referencia / Recomendación | *reh-feh-REN-see-ah / reh-koh-men-dah-see-ON* | Recommending you to others |
