...
**Cultural Context:** US workplace boundaries
...
|---------|---------|---------------|---------|
| Boundary | Límite / Frontera | *LEE-mee-teh / fron-TEH-rah* | Professional limit |
| Inappropriate | Inapropiado | *een-ah-proh-pee-AH-doh* | Unacceptable behavior |
| Harassment | Acoso | *ah-KOH-soh* | Unwelcome behavior |
| Uncomfortable | Incómodo | *een-KOH-moh-doh* | Feeling uneasy |
| Report | Reportar / Denunciar | *reh-por-TAR / deh-noon-see-AR* | Inform platform of issue |
| Safety | Seguridad | *seh-goo-ree-DAD* | Personal protection |
