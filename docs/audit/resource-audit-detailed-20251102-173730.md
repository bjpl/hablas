# DETAILED RESOURCE AUDIT REPORT
Generated: Sun, Nov  2, 2025  5:37:30 PM

## AUDIT RESULTS BY RESOURCE

### Resource 1: Frases Esenciales - Var 1
- **Type**: pdf
- **Source**: `generated-resources/50-batch/repartidor/basic_phrases_1.md`
- **Audio Phrases**: 20
- **Source Phrases Found**: 21
- **Status**: ✅ Phrase count OK (needs content verification)

**Sample Audio Phrases**:
```
...
### Resource 3: Guía Visual - Var 1
- **Type**: image
- **Source**: `generated-resources/50-batch/repartidor/basic_visual_1-image-spec.md`
- **Audio Phrases**: 3
- **Source Vocab Sections**: 0
0
...
### Resource 8: Guía Visual - Var 2
- **Type**: image
- **Source**: `generated-resources/50-batch/repartidor/basic_visual_2-image-spec.md`
- **Audio Phrases**: 3
- **Source Vocab Sections**: 3
- **Status**: ✅ Needs manual review
...
### Resource 9: Frases Esenciales - Var 4
- **Type**: pdf
...
### Resource 14: Saludos Pasajeros - Var 2
- **Type**: pdf
...
Hi there! Are you waiting for an Uber?

```

### Resource 15: Direcciones GPS - Var 2
- **Type**: pdf
- **Source**: `generated-resources/50-batch/conductor/basic_directions_2.md`
- **Audio Phrases**: 20
- **Source Phrases Found**: 28
- **Status**: ✅ Phrase count OK (needs content verification)
...
So we're heading to downtown, right?

```

### Resource 17: Saludos Pasajeros - Var 3
- **Type**: pdf
...
### Resource 18: Audio Direcciones - Var 2
- **Type**: audio
...
### Resource 20: Situaciones Difíciles - Var 1
- **Type**: pdf
...
**Sample Audio Phrases**:
```
I'm here at the pickup location. Are you on your way?

I'm here at the pickup location. Are you on your way?

Estoy aquí en el punto de recogida.


I can wait for two more minutes, then I'll have to cancel.

```

### Resource 21: Saludos Básicos - Var 1
- **Type**: audio
- **Source**: `generated-resources/50-batch/all/basic_greetings_all_1-audio-script.txt`
- **Audio Phrases**: 3
- **Source Dialogues Found**: 43
- **Status**: ⚠️ TOO FEW PHRASES (< 5)
...
### Resource 24: Vocabulario Apps - Var 1
- **Type**: image
- **Source**: `generated-resources/50-batch/all/basic_app_vocabulary_1-image-spec.md`
- **Audio Phrases**: 3
- **Source Vocab Sections**: 0
0
- **Status**: ✅ Needs manual review
...
Veo que hay un problema. Déjame
...
Necesito ayuda. Ha habido un accidente.


I'm at street and street.
...
- **Audio Phrases**: 20
- **Source Phrases Found**: 20
- **Status**: ✅ Phrase count OK (needs content verification)

**Sample Audio Phrases**:
```
I need to report a car accident. No one is injured, but we need police assistance.

I need to report a car accident. No one is injured, but we need police assistance.

Necesito reportar un accidente de auto.


I'm at the intersection of Main Street and 5th Avenue, near the gas station.
...
¿Puedo verificar dos veces el pedido
...
### Resource 34: Diálogos Reales - Var 1
- **Type**: audio
...
- **Audio Phrases**: 3
- **Source Phrases Found**: 0
0
- **Status**: ⚠️ TOO FEW PHRASES (< 10)
...
### Resource 36: Complaint Handling
- **Type**: pdf
...
### Resource 37: Conflict Resolution
- **Type**: pdf
...
### Resource 40: Earnings Optimization
- **Type**: pdf
...
### Resource 41: Negotiation Skills
- **Type**: pdf
...
### Resource 42: Professional Boundaries
- **Type**: pdf
...
### Resource 43: Professional Communication
- **Type**: pdf
...
### Resource 46: Customer Conflicts
- **Type**: pdf
...
Artículo perdido / Propiedad perdida
...
**Sample Audio Phrases**:
```
TNC lot / Staging area

TNC lot / Staging area

Área de espera TNC / Zona de preparación


Geofence / Designated pickup area
...
Tiempo Prime / Tarifa elevada


Lyft / Lyft XL / Lux / Lux Black

```

### Resource 56: Multi-App Strategy
- **Type**: pdf
...
Multi-aplicaciones / Trabajar múltiples apps
...
Contratista independiente / Trabajador autónomo
...
- Total Resources Audited: 59
- Audit Completed: Sun, Nov  2, 2025  5:37:41 PM
- Next Steps: Manual content verification for flagged resources
