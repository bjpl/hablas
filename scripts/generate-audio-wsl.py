#!/usr/bin/env python3
"""
Generate Dual-Voice Audio for Resource 1 - WSL Compatible
Adapted from generate-all-audio.py to work in WSL environment
"""
...
async def generate_dual_voice_audio():
    """Generate concatenated dual-voice audio for Resource 1"""
    resource_id = 1
    ...
    while i < len(all_lines):
        ...
        if (line_upper.startswith('SECTION ') or
            line_upper in ['CORE CONCEPTS', 'MULTI-APP STRATEGY', 'EFFICIENCY METRICS']):
            i += 1
            continue
...
async def main():
    print("🎙️  Dual-Voice Audio Generation for Resource 1")
    print("=" * 70)
    ...
    try:
        ...
        if success:
            ...
            print("📁 Location: public/audio/resource-1.mp3")
        else:
