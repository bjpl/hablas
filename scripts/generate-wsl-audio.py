#!/usr/bin/env python3
"""
WSL-Compatible Dual-Voice Audio Generator for 19 Aligned Resources
...
USAGE:
    ...
    python scripts/generate-wsl-audio.py --group 1  (50-batch resources)
    python scripts/generate-wsl-audio.py --group 2  (audio-scripts resources)
"""
...
# ============================================================================
# WSL ENVIRONMENT SETUP - MUST BE FIRST
# ============================================================================
...
# Create wrapper directory for ffmpeg/ffprobe
...
RESOURCE_PATHS = {
    # Group 1: generated-resources/50-batch (9 resources)
...
async def generate_dual_voice_audio(resource_id: int):
    ...
    for i, line in enumerate(lines):
        ...
        print(f"   [{i+1}/{len(lines)}] {lang[:2].upper()}: {line[:60]}...")
    ...
    # Export - use Windows-accessible temp directory for WAV conversion
    output_file = f'public/audio/resource-{resource_id}.mp3'
    print(f"   💾 Exporting to {output_file}...")

    # Save as WAV first (no encoding issues in WSL)
...
async def main():
    parser = argparse.ArgumentParser(
        description='WSL-Compatible Dual-Voice Audio Generator for 19 Aligned Resources',
...
"""
    ...
    if not resource_ids:
        ...
        print("\nUsage:")
        print("  python scripts/generate-wsl-audio.py --all")
        print("  python scripts/generate-wsl-audio.py --resources 2,5,7")
        print("  python scripts/generate-wsl-audio.py --group 1")
        print("  python scripts/generate-wsl-audio.py --group 2")
        return 1

    print("🎙️  WSL-Compatible Dual-Voice Audio Generation")
    print("=" * 70)
